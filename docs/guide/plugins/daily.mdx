...
![每日一句例图](/example/daily/sentence.png)
  ...
  <Recv><audio controls src={require("/example/daily/sentence.mp3").default} /></Recv>
</Example>
...
:::info
主动查看每日鉴毛、发言排行和 EPIC 喜加一的功能分别位于插件 [furbot](/docs/guide/plugins/furbot)、<PlaceholderLink href="/docs/guide/plugins/wordcloud">wordcloud</PlaceholderLink> 和 [epic_free](/docs/guide/plugins/epic_free)，并不是本插件。
